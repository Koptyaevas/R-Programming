...
submit <- local({
        getOutput <- function(sid) {
                ...
                if(sid == "pollutantmean-1") {
                        ...
                        pollutantmean("/students/koptyaevas/specdata", "sulfate", 1:10)
                }
                else if(sid == "pollutantmean-2") {
                        source("pollutantmean.R")
                        pollutantmean("/students/koptyaevas/specdata", "nitrate", 70:72)
                }
                else if(sid == "pollutantmean-3") {
                        source("pollutantmean.R")
                        pollutantmean("/students/koptyaevas/specdata", "sulfate", 34)
                }
                else if(sid == "pollutantmean-4") {
                        source("pollutantmean.R")
                        pollutantmean("/students/koptyaevas/specdata", "nitrate")
                }
